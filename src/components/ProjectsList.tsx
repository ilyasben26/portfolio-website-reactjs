    ...
    return (
        <div className='p-6 bg-gray-100 rounded-xl'>
            ...
            {projects.map(project => (
                <div key={project.id} className='bg-white  border-2 rounded-lg my-6 flex items-center p-4 shadow-sm'>
                    <img
                    ...
                    />
                    <div className="mr-2">
                        <h2 className="text-l font-semibold text-gray-700">{project.title}</h2>
                        <p className="text-sm text-gray-600 mr-1">{project.description}</p>
                    </div>
